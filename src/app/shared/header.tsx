  ...
  return (
    <header className="border-b border-border bg-bg">
      <div className="mx-auto flex max-w-[1040px] items-center justify-between px-6 py-5 sm:px-8">
        <a href="/" className="group flex items-baseline gap-3 text-text no-underline">
        ...
        <nav className="flex items-center">
          <a href={link("/apply")} className="border border-brand-green bg-brand-green px-5 py-2 text-sm font-black text-accent-text no-underline transition-colors hover:border-brand-green-hover hover:bg-brand-green-hover">
            Apply
          </a>
        </nav>
      </div>
