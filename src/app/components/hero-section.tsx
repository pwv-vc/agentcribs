...
export function HeroSection() {
  return (
    <section className="mx-auto max-w-[900px] px-6 pt-24 pb-16 sm:px-8 sm:pt-32 sm:pb-20">
      <p className="mb-5 text-sm font-bold uppercase tracking-[0.16em] text-accent">
      ...
      <p className="mt-6 max-w-[640px] text-xl leading-relaxed sm:text-2xl md:text-3xl">
        A PWV community project for people already building with AI agents.
      </p>
      <p className="mt-6 max-w-[640px] text-base leading-relaxed sm:text-lg">
        AgentCribs is publicly soft launching with an in-person event featuring
        a fireside chat between <strong>Peter Levine</strong> of a16z and{" "}
