  ...
  return (
    <>
      <Seo
        ...
        canonical="https://pwv.agentcribs.com/apply/thank-you"
      />
      <main className="mx-auto max-w-[640px] px-6 py-24 sm:px-8 sm:py-32">
        ...
        <p className="mt-5 text-base leading-relaxed text-text-secondary">
          ...
          click the verification link. That confirms your email address and
          makes your application visible to our review team. The link expires in
          1 hour.
        </p>
        <p className="mt-5 text-base leading-relaxed text-text-secondary">
