  ...
  return (
    <>
      <Seo
        ...
        description="Terms and conditions for using AgentCribs."
        canonical="https://pwv.agentcribs.com/terms"
      />
        ...
        <div className="mt-12 space-y-8 text-base leading-relaxed text-text-secondary [&_strong]:font-semibold [&_strong]:text-text">
          <section>
            ...
            <p>
              ...
              ACCESSING OR USING THIS SITE, YOU AGREE TO BE BOUND BY THE TERMS
              AND CONDITIONS DESCRIBED HEREIN AND ALL TERMS INCORPORATED BY
          ...
          <section>
            <h2 className="mb-3 text-lg font-bold text-text">Introduction</h2>
            <p>
              These Terms of Service ("Terms") apply to your access to and use
              of the websites, mobile sites and other online offerings
              (collectively, the "Site") provided by AgentCribs ("the
              Organization," "we," or "us") that link to these Terms. By
              accessing or by using our Site, you agree to these Terms, and any
              terms incorporated by reference. If you do not agree to these
              Terms, do not use our Site.
            </p>
            <p className="mt-3">
              ...
              by sending an email, providing a notice through our Site or
              updating the date at the top of these Terms. Unless we say
              otherwise in our notice, the amended Terms will be effective
              immediately, and your continued use of our Site after we provide
              such notice will confirm your acceptance of the changes. If you do
              not agree to the amended Terms, you must stop using our Site.
            </p>
            <p className="mt-3">
          ...
          <section>
            <h2 className="mb-3 text-lg font-bold text-text">Privacy</h2>
            <p>
          ...
          <section>
            <h2 className="mb-3 text-lg font-bold text-text">User Content</h2>
            <p>
              Our Site may allow you and other users to create, post, store and
              share content, including messages, comments, stories, text,
              photos, graphics, videos, and other materials (collectively, "User
              Content"). You may also submit User Content to the Organization by
              other means, including email. Except for the license you grant
            ...
            <p className="mt-3">
              ...
              the Organization, you grant the Organization and its independent
              contractors, service providers, consultants and affiliates, a
              perpetual, irrevocable, nonexclusive, royalty-free, worldwide,
              fully paid, and sublicensable license to use, reproduce, modify,
          ...
          <section>
            ...
            <p>
              ...
              provide to the Organization, and you are solely responsible for
              your conduct while using our Site.
            </p>
            <p className="mt-3">You will not:</p>
            <ul className="mt-2 list-inside list-disc space-y-1">
              ...
              <li>
                ...
                otherwise misrepresent your affiliation;
              </li>
              <li>Sell, resell or commercially use our Site;</li>
              <li>
                Copy, reproduce, distribute, publicly perform or publicly
                display all or portions of our Site, except as expressly
                permitted by us or our licensors;
              </li>
              <li>
                Modify our Site, remove any proprietary rights notices or
                markings, or otherwise make any derivative works based upon our
                Site;
              </li>
              <li>
                Use our Site in any manner that could interfere with, disrupt,
                negatively affect or inhibit other users or that could damage,
                disable, overburden or impair the functioning of our Site;
              </li>
              <li>
                Reverse engineer any aspect of our Site or bypass or circumvent
              ...
              <li>
                Develop or use any applications that interact with our Site
              ...
              <li>
                Use our Site for any illegal or unauthorized purpose, or engage
          ...
          <section>
            ...
            <p>
              ...
              owned by the Organization or our licensors and are protected under
              both United States and foreign laws. Except as explicitly stated
              in these Terms, all rights in and to the Site are reserved by us
              or our licensors. Subject to your compliance with these Terms, you
              are hereby granted a limited, nonexclusive, nontransferable,
              non-sublicensable, revocable license to access and use our Site
              for your own personal, noncommercial use.
            </p>
          </section>

          <section>
            <h2 className="mb-3 text-lg font-bold text-text">Trademarks</h2>
            <p>
              AgentCribs and PWV and our logos, our product or service names,
              our slogans and the look and feel of the Site are trademarks of
              the Organization and may not be copied, imitated or used, in whole
              or in part, without our prior written permission. All other
              trademarks, registered trademarks, product names and organization
          ...
          <section>
            <h2 className="mb-3 text-lg font-bold text-text">Feedback</h2>
            <p>
              ...
              materials or other information about the Organization or our Site
          ...
          <section>
            ...
            <div className="mt-3 rounded-lg border border-border bg-surface p-4 text-sm">
              ...
              <p>
                <strong>Address:</strong> 314 Lytton Ave Ste 200, Palo Alto, CA
                94301
              </p>
              <p>
          ...
          <section>
            ...
            <p>
              ...
              events, products, services, or activities, or we may allow third
              parties to make their content and information available on or
              through the Site (collectively, "Third-Party Content"). The
              Organization does not control or endorse, and makes no
              representations or warranties regarding, any Third-Party Content,
              and your access to and use of such Third-Party Content is at your
              own risk.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              indemnify, defend and hold harmless the Organization and its
              independent contractors, service providers, and consultants,
              successor organizations, and affiliates, and each of their
              respective officers, directors, agents, partners and employees
              (individually and collectively, the "Indemnified Parties") from
              and against any losses, liabilities, claims, demands, damages,
              expenses or costs ("Claims") arising out of or related to (a) your
              User Content or Feedback; (b) your violation of these Terms; (c)
              ...
              rights); or (d) your misconduct in connection with the Site.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              PROVIDED IN A WRITING BY US, OUR SITE AND ANY CONTENT THEREIN ARE
              PROVIDED "AS IS" AND "AS AVAILABLE" WITHOUT WARRANTIES OF ANY
              KIND, EITHER EXPRESS OR IMPLIED, INCLUDING, BUT NOT LIMITED TO,
              IMPLIED WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR
              PURPOSE, TITLE, AND NON-INFRINGEMENT. IN ADDITION, THE
              ORGANIZATION DOES NOT REPRESENT OR WARRANT THAT OUR SITE IS
          ...
          <section>
            ...
            <p>
              IN NO EVENT SHALL ORGANIZATION, OR OUR RESPECTIVE EMPLOYEES,
              AGENTS OR VOLUNTEERS BE LIABLE FOR ANY DIRECT, SPECIAL, INDIRECT
              ...
              CONNECTED WITH THE USE OF OR INABILITY TO USE THE SITE, THE
              SERVICES, THE CONTENT OR THE SITE MATERIALS CONTAINED IN OR
          ...
          <section>
            ...
            <p>
              ...
              laws of California, except to the extent preempted by U.S. federal
              law, without regard to conflict of law rules or principles. Any
              dispute between the parties will be resolved in the state or
              federal courts of California and the United States, respectively.
            </p>
          </section>

          <section>
            <h2 className="mb-3 text-lg font-bold text-text">Severability</h2>
            <p>
